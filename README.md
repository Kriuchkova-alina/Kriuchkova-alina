...
- аналитик данных в Туту.ру :mag_right:
...
- в свободное от работы время читаю классическую литературу и рисую иллюстрации :open_book:
...
|----------------|-----------------|-----|
|(__[Исследование типовых запросов клиентов из Личного кабинета, которые можно автоматизировать](https://github.com/Kriuchkova-alina/request_automatization_research)__)|Моделирование влияния изменений на метрики и их визуализация, определение топ тем и категорий, исследование поведения пользователей, выдвижение гипотез и предложений|clickhouse, metabase|
